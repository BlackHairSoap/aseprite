// Don't modify, generated file from C:/Users/jetpa/Documents/GitHub/aseprite/data/strings/en.ini
...
namespace gen {
  ...
  class Strings {
  public:
    static const std::string& _display_name() { return T::instance()->translate(".display_name"); }
    ...
    static const std::string& brush_slot_params_saved_parameters() { return T::instance()->translate("brush_slot_params.saved_parameters"); }
    ...
    static const std::string& commands_ChangePixelFormat_Indexed_ErrorDifussion() { return T::instance()->translate("commands.ChangePixelFormat_Indexed_ErrorDifussion"); }
