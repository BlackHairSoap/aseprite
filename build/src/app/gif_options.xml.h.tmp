// Don't modify, generated file from C:/Users/jetpa/Documents/GitHub/aseprite/data/widgets/gif_options.xml
...
namespace gen {
  ...
  public:
    GifOptions() : ui::Window(ui::Window::WithTitleBar) {
      ...
      app::finder(this)
        ...
        >> "loop" >> m_loop
        >> "preserve_palette_order" >> m_preservePaletteOrder
    ...
    ui::CheckBox* preservePaletteOrder() const { return m_preservePaletteOrder; }
  ...
  private:
    ...
    ui::CheckBox* m_loop;
    ui::CheckBox* m_preservePaletteOrder;
