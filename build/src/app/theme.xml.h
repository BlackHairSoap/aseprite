// Don't modify, generated file from C:/Users/jetpa/Documents/GitHub/aseprite/data/extensions/aseprite-theme/theme.xml
...
namespace gen {
  ...
  public:
    ...
    public:
      ...
      int paletteEntriesSeparator() const { return m_paletteEntriesSeparator; }
      int colorSliderHeight() const { return m_colorSliderHeight; }
      int timelineBaseSize() const { return m_timelineBaseSize; }
      int colorBarButtonsHeight() const { return m_colorBarButtonsHeight; }
      int contextBarHeight() const { return m_contextBarHeight; }
      int brushTypeWidth() const { return m_brushTypeWidth; }
      int colorSelectorBarSize() const { return m_colorSelectorBarSize; }
    private:
      int m_scrollbarSize;
      ...
      int m_paletteEntriesSeparator;
      int m_colorSliderHeight;
      int m_timelineBaseSize;
      int m_colorBarButtonsHeight;
      int m_contextBarHeight;
      int m_brushTypeWidth;
      int m_colorSelectorBarSize;
    };
    class Colors {
      template<typename> friend class ThemeFile;
    public:
      ...
      gfx::Color paletteEntriesSeparator() const { return m_paletteEntriesSeparator; }
    private:
      gfx::Color m_text;
      ...
      gfx::Color m_paletteEntriesSeparator;
    };
    class Parts {
      template<typename> friend class ThemeFile;
    public:
      ...
      const skin::SkinPartPtr& arrowCircleCw() const { return m_arrowCircleCw; }
      const skin::SkinPartPtr& arrowCircleCwSelected() const { return m_arrowCircleCwSelected; }
      ...
      const skin::SkinPartPtr& listView() const { return m_listView; }
      const skin::SkinPartPtr& smallIconView() const { return m_smallIconView; }
      const skin::SkinPartPtr& bigIconView() const { return m_bigIconView; }
      ...
      const skin::SkinPartPtr& buttonsetItemActive() const { return m_buttonsetItemActive; }
      ...
      const skin::SkinPartPtr& debugContinue() const { return m_debugContinue; }
      const skin::SkinPartPtr& debugPause() const { return m_debugPause; }
      const skin::SkinPartPtr& debugStepInto() const { return m_debugStepInto; }
      const skin::SkinPartPtr& debugStepOver() const { return m_debugStepOver; }
      const skin::SkinPartPtr& debugStepOut() const { return m_debugStepOut; }
      const skin::SkinPartPtr& debugBreakpoint() const { return m_debugBreakpoint; }
      ...
      const skin::SkinPartPtr& selectionIntersect() const { return m_selectionIntersect; }
      ...
      const skin::SkinPartPtr& timelineZindex() const { return m_timelineZindex; }
      ...
      const skin::SkinPartPtr& iconAspectRatio() const { return m_iconAspectRatio; }
      const skin::SkinPartPtr& iconDelta() const { return m_iconDelta; }
      ...
      const skin::SkinPartPtr& linearGradient() const { return m_linearGradient; }
      const skin::SkinPartPtr& radialGradient() const { return m_radialGradient; }
      const skin::SkinPartPtr& folderIconSmall() const { return m_folderIconSmall; }
      const skin::SkinPartPtr& folderIconBig() const { return m_folderIconBig; }
      const skin::SkinPartPtr& folderIconMedium() const { return m_folderIconMedium; }
      const skin::SkinPartPtr& outlineCircle() const { return m_outlineCircle; }
      const skin::SkinPartPtr& outlineSquare() const { return m_outlineSquare; }
      const skin::SkinPartPtr& outlineHorizontal() const { return m_outlineHorizontal; }
      const skin::SkinPartPtr& outlineVertical() const { return m_outlineVertical; }
      const skin::SkinPartPtr& outlineEmptyPixel() const { return m_outlineEmptyPixel; }
      const skin::SkinPartPtr& outlineFullPixel() const { return m_outlineFullPixel; }
      const skin::SkinPartPtr& dynamics() const { return m_dynamics; }
      const skin::SkinPartPtr& tiles() const { return m_tiles; }
      const skin::SkinPartPtr& tilesManual() const { return m_tilesManual; }
      const skin::SkinPartPtr& tilesAuto() const { return m_tilesAuto; }
      const skin::SkinPartPtr& tilesStack() const { return m_tilesStack; }
      const skin::SkinPartPtr& oneWinIcon() const { return m_oneWinIcon; }
      const skin::SkinPartPtr& multiWinIcon() const { return m_multiWinIcon; }
      const skin::SkinPartPtr& spinUp() const { return m_spinUp; }
      const skin::SkinPartPtr& spinDown() const { return m_spinDown; }
    private:
      ...
      skin::SkinPartPtr m_arrowCircleCw;
      skin::SkinPartPtr m_arrowCircleCwSelected;
      skin::SkinPartPtr m_newfolder;
      skin::SkinPartPtr m_newfolderSelected;
      skin::SkinPartPtr m_listView;
      skin::SkinPartPtr m_smallIconView;
      skin::SkinPartPtr m_bigIconView;
      ...
      skin::SkinPartPtr m_buttonsetItemActive;
      ...
      skin::SkinPartPtr m_debugContinue;
      skin::SkinPartPtr m_debugPause;
      skin::SkinPartPtr m_debugStepInto;
      skin::SkinPartPtr m_debugStepOver;
      skin::SkinPartPtr m_debugStepOut;
      skin::SkinPartPtr m_debugBreakpoint;
      skin::SkinPartPtr m_selectionReplace;
      skin::SkinPartPtr m_selectionAdd;
      skin::SkinPartPtr m_selectionSubtract;
      skin::SkinPartPtr m_selectionIntersect;
      ...
      skin::SkinPartPtr m_timelineZindex;
      ...
      skin::SkinPartPtr m_iconAspectRatio;
      skin::SkinPartPtr m_iconDelta;
      ...
      skin::SkinPartPtr m_linearGradient;
      skin::SkinPartPtr m_radialGradient;
      skin::SkinPartPtr m_folderIconSmall;
      skin::SkinPartPtr m_folderIconBig;
      skin::SkinPartPtr m_folderIconMedium;
      skin::SkinPartPtr m_outlineCircle;
      skin::SkinPartPtr m_outlineSquare;
      skin::SkinPartPtr m_outlineHorizontal;
      skin::SkinPartPtr m_outlineVertical;
      skin::SkinPartPtr m_outlineEmptyPixel;
      skin::SkinPartPtr m_outlineFullPixel;
      skin::SkinPartPtr m_dynamics;
      skin::SkinPartPtr m_tiles;
      skin::SkinPartPtr m_tilesManual;
      skin::SkinPartPtr m_tilesAuto;
      skin::SkinPartPtr m_tilesStack;
      skin::SkinPartPtr m_oneWinIcon;
      skin::SkinPartPtr m_multiWinIcon;
      skin::SkinPartPtr m_spinUp;
      skin::SkinPartPtr m_spinDown;
    };
    class Cursors {
      template<typename> friend class ThemeFile;
    public:
      ...
      const ui::Cursor* skewN() const { return m_skewN; }
      const ui::Cursor* skewS() const { return m_skewS; }
      const ui::Cursor* skewSw() const { return m_skewSw; }
      const ui::Cursor* skewSe() const { return m_skewSe; }
      const ui::Cursor* skewW() const { return m_skewW; }
      const ui::Cursor* skewE() const { return m_skewE; }
      const ui::Cursor* skewNw() const { return m_skewNw; }
      const ui::Cursor* skewNe() const { return m_skewNe; }
    private:
      ui::Cursor* m_normal;
    ...
    public:
      ...
      ui::Style* textboxText() const { return m_textboxText; }
      ui::Style* textboxLabel() const { return m_textboxLabel; }
      ...
      ui::Style* combobox() const { return m_combobox; }
      ...
      ui::Style* refreshButton() const { return m_refreshButton; }
      ...
      ui::Style* separatorInViewReverse() const { return m_separatorInViewReverse; }
      ...
      ui::Style* recentFilePin() const { return m_recentFilePin; }
      ...
      ui::Style* workspaceCheckBox() const { return m_workspaceCheckBox; }
      ...
      ui::Style* timelineTilemapLayer() const { return m_timelineTilemapLayer; }
      ...
      ui::Style* timelineZindex() const { return m_timelineZindex; }
      ...
      ui::Style* undoSavedItem() const { return m_undoSavedItem; }
      ui::Style* asepriteFace() const { return m_asepriteFace; }
      ui::Style* slider() const { return m_slider; }
      ui::Style* miniSlider() const { return m_miniSlider; }
      ui::Style* buttonset() const { return m_buttonset; }
      ui::Style* buttonsetItem() const { return m_buttonsetItem; }
      ui::Style* buttonsetItemIcon() const { return m_buttonsetItemIcon; }
      ui::Style* buttonsetItemIconMono() const { return m_buttonsetItemIconMono; }
      ui::Style* buttonsetItemText() const { return m_buttonsetItemText; }
      ui::Style* buttonsetItemTextTop() const { return m_buttonsetItemTextTop; }
      ui::Style* buttonsetItemTextTopIconBottom() const { return m_buttonsetItemTextTopIconBottom; }
      ui::Style* newSpriteRgb() const { return m_newSpriteRgb; }
      ui::Style* newSpriteGrayscale() const { return m_newSpriteGrayscale; }
      ui::Style* newSpriteIndexed() const { return m_newSpriteIndexed; }
      ui::Style* bgTransparent() const { return m_bgTransparent; }
      ui::Style* bgWhite() const { return m_bgWhite; }
      ui::Style* bgBlack() const { return m_bgBlack; }
      ui::Style* dirItem() const { return m_dirItem; }
      ui::Style* contextBarButton() const { return m_contextBarButton; }
      ui::Style* contextBarTextButton() const { return m_contextBarTextButton; }
      ui::Style* brushType() const { return m_brushType; }
      ui::Style* brushTypeMono() const { return m_brushTypeMono; }
      ui::Style* inkType() const { return m_inkType; }
      ui::Style* dynamicsField() const { return m_dynamicsField; }
      ui::Style* pivotField() const { return m_pivotField; }
      ui::Style* pivotDir() const { return m_pivotDir; }
      ui::Style* selectionMode() const { return m_selectionMode; }
      ui::Style* symmetryField() const { return m_symmetryField; }
      ui::Style* symmetryOptions() const { return m_symmetryOptions; }
      ui::Style* palEditLock() const { return m_palEditLock; }
      ui::Style* palEditUnlock() const { return m_palEditUnlock; }
      ui::Style* palButton() const { return m_palButton; }
      ui::Style* debuggerButton() const { return m_debuggerButton; }
      ui::Style* editPixelsMode() const { return m_editPixelsMode; }
      ui::Style* editTilesMode() const { return m_editTilesMode; }
      ui::Style* standardBrush() const { return m_standardBrush; }
      ui::Style* outlineCell() const { return m_outlineCell; }
      ui::Style* aniButton() const { return m_aniButton; }
      ui::Style* multiWindowItem() const { return m_multiWindowItem; }
    private:
      ui::Style* m_box;
      ui::Style* m_grid;
      ...
      ui::Style* m_textboxText;
      ui::Style* m_textboxLabel;
      ui::Style* m_label;
      ...
      ui::Style* m_timelineTilemapLayer;
      ...
      ui::Style* m_listItem;
      ui::Style* m_undoSavedItem;
      ui::Style* m_asepriteFace;
      ui::Style* m_slider;
      ui::Style* m_miniSlider;
      ui::Style* m_buttonset;
      ui::Style* m_buttonsetItem;
      ui::Style* m_buttonsetItemIcon;
      ui::Style* m_buttonsetItemIconMono;
      ui::Style* m_buttonsetItemText;
      ui::Style* m_buttonsetItemTextTop;
      ui::Style* m_buttonsetItemTextTopIconBottom;
      ui::Style* m_newSpriteRgb;
      ui::Style* m_newSpriteGrayscale;
      ui::Style* m_newSpriteIndexed;
      ui::Style* m_bgTransparent;
      ui::Style* m_bgWhite;
      ui::Style* m_bgBlack;
      ui::Style* m_dirItem;
      ui::Style* m_contextBarButton;
      ui::Style* m_contextBarTextButton;
      ui::Style* m_brushType;
      ui::Style* m_brushTypeMono;
      ui::Style* m_inkType;
      ui::Style* m_dynamicsField;
      ui::Style* m_pivotField;
      ui::Style* m_pivotDir;
      ui::Style* m_selectionMode;
      ui::Style* m_symmetryField;
      ui::Style* m_symmetryOptions;
      ui::Style* m_palEditLock;
      ui::Style* m_palEditUnlock;
      ui::Style* m_palButton;
      ui::Style* m_debuggerButton;
      ui::Style* m_editPixelsMode;
      ui::Style* m_editTilesMode;
      ui::Style* m_standardBrush;
      ui::Style* m_outlineCell;
      ui::Style* m_aniButton;
      ui::Style* m_multiWindowItem;
    };
  ...
  protected:
    void updateInternals() {
      ...
      byId(dimensions.m_paletteEntriesSeparator, "palette_entries_separator");
      byId(dimensions.m_colorSliderHeight, "color_slider_height");
      byId(dimensions.m_timelineBaseSize, "timeline_base_size");
      byId(dimensions.m_colorBarButtonsHeight, "color_bar_buttons_height");
      byId(dimensions.m_contextBarHeight, "context_bar_height");
      byId(dimensions.m_brushTypeWidth, "brush_type_width");
      byId(dimensions.m_colorSelectorBarSize, "color_selector_bar_size");
      ...
      byId(colors.m_paletteEntriesSeparator, "palette_entries_separator");
      ...
      byId(parts.m_arrowCircleCw, "arrow_circle_cw");
      byId(parts.m_arrowCircleCwSelected, "arrow_circle_cw_selected");
      byId(parts.m_newfolder, "newfolder");
      byId(parts.m_newfolderSelected, "newfolder_selected");
      byId(parts.m_listView, "list_view");
      byId(parts.m_smallIconView, "small_icon_view");
      byId(parts.m_bigIconView, "big_icon_view");
      ...
      byId(parts.m_buttonsetItemActive, "buttonset_item_active");
      ...
      byId(parts.m_debugContinue, "debug_continue");
      byId(parts.m_debugPause, "debug_pause");
      byId(parts.m_debugStepInto, "debug_step_into");
      byId(parts.m_debugStepOver, "debug_step_over");
      byId(parts.m_debugStepOut, "debug_step_out");
      byId(parts.m_debugBreakpoint, "debug_breakpoint");
      ...
      byId(parts.m_selectionIntersect, "selection_intersect");
      ...
      byId(parts.m_timelineZindex, "timeline_zindex");
      ...
      byId(parts.m_iconAspectRatio, "icon_aspect_ratio");
      byId(parts.m_iconDelta, "icon_delta");
      ...
      byId(parts.m_linearGradient, "linear_gradient");
      byId(parts.m_radialGradient, "radial_gradient");
      byId(parts.m_folderIconSmall, "folder_icon_small");
      byId(parts.m_folderIconBig, "folder_icon_big");
      byId(parts.m_folderIconMedium, "folder_icon_medium");
      byId(parts.m_outlineCircle, "outline_circle");
      byId(parts.m_outlineSquare, "outline_square");
      byId(parts.m_outlineHorizontal, "outline_horizontal");
      byId(parts.m_outlineVertical, "outline_vertical");
      byId(parts.m_outlineEmptyPixel, "outline_empty_pixel");
      byId(parts.m_outlineFullPixel, "outline_full_pixel");
      byId(parts.m_dynamics, "dynamics");
      byId(parts.m_tiles, "tiles");
      byId(parts.m_tilesManual, "tiles_manual");
      byId(parts.m_tilesAuto, "tiles_auto");
      byId(parts.m_tilesStack, "tiles_stack");
      byId(parts.m_oneWinIcon, "one_win_icon");
      byId(parts.m_multiWinIcon, "multi_win_icon");
      byId(parts.m_spinUp, "spin_up");
      byId(parts.m_spinDown, "spin_down");
      ...
      byId(cursors.m_skewN, "skew_n");
      byId(cursors.m_skewS, "skew_s");
      byId(cursors.m_skewSw, "skew_sw");
      byId(cursors.m_skewSe, "skew_se");
      byId(cursors.m_skewW, "skew_w");
      byId(cursors.m_skewE, "skew_e");
      byId(cursors.m_skewNw, "skew_nw");
      byId(cursors.m_skewNe, "skew_ne");
      ...
      byId(styles.m_textboxText, "textbox_text");
      byId(styles.m_textboxLabel, "textbox_label");
      ...
      byId(styles.m_combobox, "combobox");
      ...
      byId(styles.m_refreshButton, "refresh_button");
      ...
      byId(styles.m_separatorInViewReverse, "separator_in_view_reverse");
      ...
      byId(styles.m_recentFilePin, "recent_file_pin");
      ...
      byId(styles.m_workspaceCheckBox, "workspace_check_box");
      ...
      byId(styles.m_timelineTilemapLayer, "timeline_tilemap_layer");
      ...
      byId(styles.m_timelineZindex, "timeline_zindex");
      ...
      byId(styles.m_undoSavedItem, "undo_saved_item");
      byId(styles.m_asepriteFace, "aseprite_face");
      byId(styles.m_slider, "slider");
      byId(styles.m_miniSlider, "mini_slider");
      byId(styles.m_buttonset, "buttonset");
      byId(styles.m_buttonsetItem, "buttonset_item");
      byId(styles.m_buttonsetItemIcon, "buttonset_item_icon");
      byId(styles.m_buttonsetItemIconMono, "buttonset_item_icon_mono");
      byId(styles.m_buttonsetItemText, "buttonset_item_text");
      byId(styles.m_buttonsetItemTextTop, "buttonset_item_text_top");
      byId(styles.m_buttonsetItemTextTopIconBottom, "buttonset_item_text_top_icon_bottom");
      byId(styles.m_newSpriteRgb, "new_sprite_rgb");
      byId(styles.m_newSpriteGrayscale, "new_sprite_grayscale");
      byId(styles.m_newSpriteIndexed, "new_sprite_indexed");
      byId(styles.m_bgTransparent, "bg_transparent");
      byId(styles.m_bgWhite, "bg_white");
      byId(styles.m_bgBlack, "bg_black");
      byId(styles.m_dirItem, "dir_item");
      byId(styles.m_contextBarButton, "context_bar_button");
      byId(styles.m_contextBarTextButton, "context_bar_text_button");
      byId(styles.m_brushType, "brush_type");
      byId(styles.m_brushTypeMono, "brush_type_mono");
      byId(styles.m_inkType, "ink_type");
      byId(styles.m_dynamicsField, "dynamics_field");
      byId(styles.m_pivotField, "pivot_field");
      byId(styles.m_pivotDir, "pivot_dir");
      byId(styles.m_selectionMode, "selection_mode");
      byId(styles.m_symmetryField, "symmetry_field");
      byId(styles.m_symmetryOptions, "symmetry_options");
      byId(styles.m_palEditLock, "pal_edit_lock");
      byId(styles.m_palEditUnlock, "pal_edit_unlock");
      byId(styles.m_palButton, "pal_button");
      byId(styles.m_debuggerButton, "debugger_button");
      byId(styles.m_editPixelsMode, "edit_pixels_mode");
      byId(styles.m_editTilesMode, "edit_tiles_mode");
      byId(styles.m_standardBrush, "standard_brush");
      byId(styles.m_outlineCell, "outline_cell");
      byId(styles.m_aniButton, "ani_button");
      byId(styles.m_multiWindowItem, "multi_window_item");
    }
