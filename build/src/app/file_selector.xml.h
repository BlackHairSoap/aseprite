// Don't modify, generated file from C:/Users/jetpa/Documents/GitHub/aseprite/data/widgets/file_selector.xml
  ...
  public:
    FileSelector() : ui::Window(ui::Window::WithTitleBar) {
      ...
      app::finder(this)
        ...
        >> "location" >> m_location
        >> "refresh_button" >> m_refreshButton
    ...
    app::ButtonSet* viewType() const { return m_viewType; }
    ui::ComboBox* location() const { return m_location; }
    ui::Button* refreshButton() const { return m_refreshButton; }
